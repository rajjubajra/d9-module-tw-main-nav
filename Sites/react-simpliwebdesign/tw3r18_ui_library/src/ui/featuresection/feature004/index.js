...
function Feature004() {
  ...
  <div>
    <div className="my-10 flex flex-wrap font-mono">
        {
          data?.map( item => {
            return <div className="bg-gray-800 text-gray-200 md:p-10 p-5 md:border m-1 my-10">
                {item.text}
            </div>
          })
        }
