...
function Feature002() {
  ...
  <div className="w-full min-h-screen md:flex">
    ...
    <div className='md:w-1/6 bg-gray-200 md:h-screen'>
      <div className='md:-rotate-90 md:translate-y-96 dark:text-slate-800 text-6xl tracking-wider'> Feature
      </div>
    </div>

    <div className='w-full md:pl-6 md:ml-5'>
        <div>
        {/** title */}
        ...
        <div className="md:my-10 flex flex-wrap font-mono">
            {
              data?.map( item => {
                return <div className="md:w-1/2 md:p-10 my-5 md:border-l md:my-10">
                    {item.text}
                </div>
              })
            }
