...
function Card({date, subject, title, summary, by, image}) {
  return (
    <div className='relative md:min-h-[47em] px-6 py-4 m-2 border shadow-lg bg-gray-100 dark:bg-slate-800 dark:border-slate-600'>
      ...
      {/** IMAGE */}
      <div>
        <img className='md:block md:w-full md:max-h-96 md:float-none   float-left w-56 max-h-36 object-cover pr-4 pb-4' src={image}  alt={subject} />
      </div>
      ...
      <div className='absolute bottom-0 my-5 w-11/12'>
      {/** READ NAVIGATION */}
