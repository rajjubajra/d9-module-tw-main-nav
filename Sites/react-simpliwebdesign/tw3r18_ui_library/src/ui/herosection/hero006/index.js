...
function Hero006() {
  ...
  return (
    <div className='relative w-full h-screen flex flex-col justify-center items-end'>

      {/** HEALINE */}
      <div className='text-6xl md:w-1/2 font-thin tracking-wider mb-6 text-right'>Empower Your Life with Knowledge</div>
