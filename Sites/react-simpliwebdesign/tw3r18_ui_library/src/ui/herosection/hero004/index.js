...
function Hero004() {
  ...
  return (
    <div className='relative w-full h-screen flex flex-col justify-center items-center'>
      ...
      {/** HEALINE */}
      <div className='text-6xl md:w-1/2 text-center font-thin tracking-wider mb-6'>Empower Your Life with Knowledge</div>

      {/** SUMMARY */}
      <div className='text-xl md:w-3/4 m-6 tracking-wider font-light'>
      ...
      {/** BUTTON */}
      <div className='py-2 px-6 bg-slate-700 text-gray-100 border border-black cursor-pointer hover:bg-gray-900'>Learn more</div>
